...
//General consts
export const IMAGES_DIRECTORY_ANDROID = RNFetchBlob.fs.dirs.PictureDir + '/RNChat/images/';
export const AUDIO_DIRECTORY_ANDROID = RNFetchBlob.fs.dirs.MusicDir + '/RNChat/audio/';
export const AUDIO_DIRECTORY_IOS = RNFetchBlob.fs.dirs.DocumentDir + '/RNChat/audio/';
