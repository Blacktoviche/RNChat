...
import { emailChanged, passwordChanged, rePasswordChanged, registerUser } from '../core/actions';
            ...
            <Container>
                <Content>
                    <Form>
                        ...
                        <Item rounded>
                            <Input placeholder="Re-Password" value={this.props.rePassword} secureTextEntry
...
export default connect(mapStateToProps, {
    emailChanged, passwordChanged, rePasswordChanged, registerUser
})(Register);