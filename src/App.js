...
import { setupLoggedinUser, networkStatusChanged, sendQueuedMessages, changeCurrentScreen } from './core/actions';
...
class App extends Component {
    ...
    renderNavigator() {
        ...
        if (this.props.loggedinUser) {
            return (<MainNavigator loggedinUser={this.props.loggedinUser}
...
export default connect(mapStateToProps, {
    setupLoggedinUser, sendQueuedMessages, networkStatusChanged, changeCurrentScreen
})(App);